...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._HeaderComponent_0_4 = new import10.HeaderComponent();
    ...
    this._el_4 = this.renderer.createElement(parentRenderNode,'router-outlet',(null as any));
    this._appEl_4 = new import2.AppElement(4,(null as any),this,this._el_4);
    this._RouterOutlet_4_5 = new import11.RouterOutlet(this.parentInjector.get(import13.RouterOutletMap),this._appEl_4.vcRef,this.parentInjector.get(import14.ComponentFactoryResolver),(null as any));
    this.init([],[
      this._el_0,
      this._text_1,
      this._el_2,
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/alex/Desktop/nodeJs/Quiz/assets/app/app.component.html',0,import8.ViewEncapsulation.None,styles_AppComponent,{})); }
