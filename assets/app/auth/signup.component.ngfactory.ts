...
export function viewFactory_SignUpComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SignUpComponent> {
  if ((renderType_SignUpComponent === (null as any))) { (renderType_SignUpComponent = viewUtils.createRenderComponentType('C:/Users/alex/Desktop/nodeJs/Quiz/assets/app/auth/signup.component.html',0,import9.ViewEncapsulation.None,styles_SignUpComponent,{})); }
